  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex w-full sm:max-w-5xl mx-auto justify-center flex-col lg:flex-row items-center gap-20 my-20"
      >
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6 }}
          className="hidden sm:flex sm:w-80 rounded-3xl max-w-none"
        >
          <Image
